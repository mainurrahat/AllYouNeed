    ...
    const aboutList = [
        {
            ...
            desc: 'Our trusted sellers offer top-quality products with reliable delivery services, ensuring customer satisfaction.',
          },
          {
            imgUrl: '/src/assets/images/about/icon/02.jpg',
            imgAlt: 'about icon rajibraj91 rajibraj',
            title: 'Exclusive Discounts',
            desc: 'Enjoy exclusive deals and discounts on a wide range of products, only available to our customers.',
          },
          {
            imgUrl: '/src/assets/images/about/icon/03.jpg',
            imgAlt: 'about icon rajibraj91 rajibraj',
            title: 'Secure Shopping',
            desc: 'Shop with confidence knowing that your personal information and transactions are securely protected.'
          },
